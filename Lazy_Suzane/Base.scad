    ...
    difference(){
        ...
        union(){
            ...
            union(){
                ...
                for(i=[45:90:360]){
                    translate([nut_radius * sin(i), nut_radius * cos(i), holder_height])
                    rotate([90+i, 90, 0])
                    NutM4();
                    ...
                    BoltM4(25, inset=0);
                    //Bearing:
                    translate([(bolt_radius +5) * sin(i), (bolt_radius +5) * cos(i), holder_height])
                    rotate([i+90,90, 0])
                    cylinder(r=14, h=14);
                }
            }
...
/*
for(i=[45:90:360]){
    #translate([100 * sin(i), 100 * cos(i), 24])
    rotate([i-90, 90, 0])
    cylinder(r=13, h=8);
}
*/